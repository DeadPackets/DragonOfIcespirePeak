...
| Roll | Result |
|------|--------|
| 1-3 | [Stirges](/compendium/bestiary/beast/stirge.md) (`2d4`) |
| 4-5 | [Ghouls](/compendium/bestiary/undead/ghoul.md) (`1d4`) |
| 6 | [Gricks](/compendium/bestiary/monstrosity/grick.md) (`1d4`) |
| 7-8 | [Bugbears](/compendium/bestiary/humanoid/bugbear.md) (`1d4`) |
| 9 | [Skeletons](/compendium/bestiary/undead/skeleton.md) (`1d6`) |
| 10 | [Zombies](/compendium/bestiary/undead/zombie.md) (`1d6`) |
| 11-12 | [Ochre Jelly](/compendium/bestiary/ooze/ochre-jelly.md) (1) |
^wandering-monsters

![Wave Echo Cave](/compendium/adventures/lost-mine-of-phandelver/img/wave-echo-cave.jpg#center)

![Player Version](/compendium/adventures/lost-mine-of-phandelver/img/wave-echo-cave-player.jpg#center)
...
Whenever a creature attempts to cross the cavern, the carpets of fungi that cover most of the floor release poisonous gas into the air. Each creature in the cavern must succeed on a DC 11 Constitution saving throw or take `3d6` poison damage and be [poisoned](/compendium/rules/conditions.md#poisoned) for 10 minutes (see the rulebook for more information on the [poisoned](/compendium/rules/conditions.md#poisoned) condition). The gas disperses after 1 minute, but until then, any living creature that ends its turn in the cavern must repeat the saving throw.
...
The escarpments are 10 feet high and require a successful DC 12 Strength ([Athletics](/compendium/rules/skills.md#Athletics)) check to climb. A creature that falls or is knocked from the top of a ledge takes `1d6` bludgeoning damage and lands [prone](/compendium/rules/conditions.md#prone).
...
Nezznar carries a potion of healing and a [spider staff](/compendium/items/spider-staff-lmop.md). In addition, the drow carries an iron key with a head shaped like an anvil. This key unlocks the door to 20.
